...
ostream& operator<<(ostream& o,const timeType& peep)
{
  ...
  {
    o << "The current time is: " << peep.getHours() - 12 << ":" << "0" << peep.getMinutes() << " " << tmpTime << "\n";
    return o;
  }
  else if (peep.getHours() > 12)
  {
    o << "The current time is: " << peep.getHours() - 12 << ":" << peep.getMinutes() << " " << tmpTime << "\n";
    return o;
  }
  else if (peep.getHours() == 0 && peep.getMinutes() < 10)
  {
    o << "The current time is: " << 12 << ":" << "0" << peep.getMinutes() << " " << "AM" << "\n";
    return o;
  }
  else if (peep.getHours() == 0)
  {
    o << "The current time is: " << 12 << ":" << peep.getMinutes() << " " << tmpTime << "\n";
    return o;
  }
  else if (peep.getMinutes() < 10)
  {
    o << "The current time is: " << peep.getHours() << ":" << "0" << peep.getMinutes() << " " << tmpTime << "\n";
    return o;
  }
  else
  {
    o << "The current time is: " << peep.getHours() << ":" << peep.getMinutes() << " " << tmpTime << "\n";
    return o;
  }
}
